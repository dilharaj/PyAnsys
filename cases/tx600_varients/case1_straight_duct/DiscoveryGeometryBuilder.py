...
import shutil
# USER INPUT
case_folder = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight_duct"
num_blades = 13
# Set 3D View
...
# Insert Geometry
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight duct\case1.STEP")
rotor_body = BodySelection.Create(GetRootPart().Components[0].Content.Bodies[0])
stl_file = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight_duct\\geo.stl"
# Save Project As
File.SaveAs(stl_file)
# EndBlock
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight_duct\geo0.dsco")
# Enclosure
...
if centroid.X > 0.3:
    ...
    nearbody = b1
lf = open(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight_duct\log.dat","w")
lf.write("Check1\n")
# Named Selections
...
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight_duct\geo.dsco")
Workbench.Fluent.ExportPMDB(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx600_varients\case1_straight_duct\case.pmdb")
