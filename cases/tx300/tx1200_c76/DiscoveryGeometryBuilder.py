...
import shutil
# USER INPUT
case_folder = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76"
num_blades = 8
# Set 3D View
...
# Insert Geometry
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76\case76.STEP")
rotor_body = BodySelection.Create(GetRootPart().Components[0].Content.Bodies[0])
stl_file = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76\\geo.stl"
# Save Project As
File.SaveAs(stl_file)
# EndBlock
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76\geo0.dsco")
# Enclosure
...
point1 = Point2D.Create(M(0.5),M(0))
point2 = Point2D.Create(M(-1.0),M(0))
point3 = Point2D.Create(M(-1.0),M(0.8))
result = SketchRectangle.Create(point1, point2, point3)
point1 = Point2D.Create(M(6.0),M(0))
point2 = Point2D.Create(M(-6.0),M(0))
point3 = Point2D.Create(M(-6.0),M(6.0))
result = SketchRectangle.Create(point1, point2, point3)
mode = InteractionMode.Solid
sketch_result = ViewHelper.SetViewMode(mode)
...
if centroid.X > 0.6:
    ...
    nearbody = b1
lf = open(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76\log.dat","w")
lf.write("Check1\n")
# Named Selections
...
cent_x[i_per1_near] = -600.0
cent_x[i_per2_near] = -600.0
...
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76\geo.dsco")
Workbench.Fluent.ExportPMDB(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76\case.pmdb")
