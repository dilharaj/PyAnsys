...
import shutil
# USER INPUT
case_folder = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled"
num_blades = 8
# Set 3D View
...
# Insert Geometry
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled\case76_scaled_down.STEP")
rotor_body = BodySelection.Create(GetRootPart().Components[0].Content.Bodies[0])
stl_file = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled\\geo.stl"
# Save Project As
File.SaveAs(stl_file)
# EndBlock
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled\geo0.dsco")
# Enclosure
...
point1 = Point2D.Create(M(0.125),M(0))
point2 = Point2D.Create(M(-0.25),M(0))
point3 = Point2D.Create(M(-0.25),M(0.2))
...
if centroid.X > 0.15:
    ...
    nearbody = b1
lf = open(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled\log.dat","w")
lf.write("Check1\n")
# Named Selections
...
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled\geo.dsco")
Workbench.Fluent.ExportPMDB(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\tx1200_c76_scaled\case.pmdb")
