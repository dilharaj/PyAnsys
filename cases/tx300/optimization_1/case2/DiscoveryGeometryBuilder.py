...
import shutil
# USER INPUT
case_folder = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2"
num_blades = 9
# Set 3D View
...
# Blade
airfoil_files = []
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_0.txt")
...
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_1.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_2.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_3.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_4.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_5.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_6.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_7.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_8.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
airfoil_files.append(Fill.Execute(selection, empty, options, FillMode.ThreeD))
Delete.Execute(selection)
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\\\blade_cross_9.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
empty = Selection.Empty()
options = FillOptions()
...
ComponentHelper.DeleteEmptyComponents(GetRootPart())
# Duct
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\duct.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
...
# Hub
File.InsertGeometry(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\hub.txt")
selection = Selection.Create([GetRootPart().Curves[0]])
result = Scale.Execute(selection, scale_origin, scale_factor, False)
secondarySelection = Selection.Empty()
options = FillOptions()
...
stl_file = r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\\geo.stl"
# Save Project As
File.SaveAs(stl_file)
# EndBlock
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\geo0.dsco")
# Enclosure
...
if centroid.X > 0.15:
    ...
    nearbody = b1
lf = open(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\log.dat","w")
lf.write("Check1\n")
# Named Selections
...
# Save Project As
File.SaveAs(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\geo.dsco")
Workbench.Fluent.ExportPMDB(r"Z:\UFX_dilhara\Ansys\3D_CFD_Optimizer\Manual\cases\tx300\optimization_1\case2\case.pmdb")
